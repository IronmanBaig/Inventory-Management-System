...
<div style="height: 200vh;" class="dashboard_sidebar" id="dashboard_sidebar">
        ...
        <div class="dashboard_sidebar_menus">
            <ul class="dashboard_menu_lists">
                <!-- class="menuActive" -->
                  ...
                  <ul class="subMenus" >
                        <li><a class="subMenuLink" href="./product-viewc.php"><i class="fa fa-circle-o"></i> View Products</a></li>
                  ...
                  <li class="liMainMenu">
                    ...
                    <span class="menuText showHideSubMenu">Purchase Product</span>
                    <i class="fa fa-angle-left mainMenuIconArrow showHideSubMenu"></i>
                  </a>

                  <ul class="subMenus" >
                        <li><a class="subMenuLink" href="./product-orderc.php"><i class="fa fa-circle-o"></i> Create Order</a></li>
                        <li><a class="subMenuLink" href="./view-orderc.php"><i class="fa fa-circle-o"></i> View Orders</a></li>
                  </ul>
